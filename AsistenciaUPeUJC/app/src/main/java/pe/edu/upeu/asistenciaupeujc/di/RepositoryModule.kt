...
import pe.edu.upeu.asistenciaupeujc.repository.EventoRepositoryImp
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun eventoRespository(actRepos: MaterialesxRepositoryImp): MaterialesxRepository
