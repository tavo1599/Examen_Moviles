...
sealed class Destinations(
    ...
    object EventoUi: Destinations("eventoUI", "Adm Eventos", Icons.Filled.DateRange)

    object EventoForm: Destinations("eventoForm?matId={matId}", "Form Evento", Icons.Filled.Add){
        fun passId(eventId:String?):String{
            return "eventoForm?matId=$eventId"
        }
    }
