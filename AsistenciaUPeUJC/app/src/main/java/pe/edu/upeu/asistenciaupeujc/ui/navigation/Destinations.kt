...
sealed class Destinations(
    ...
    object EventoUI: Destinations("eventoUI","adm Evento", Icons.Default.AccountBox)
    object EventoForm: Destinations("eventoForm?eventId={eventId}", "Form evento", Icons.Filled.Add){
        fun passId(eventId:String?):String{
            return "eventoForm?eventId=$eventId"
        }
    }
